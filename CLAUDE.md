...
**IMPORTANT:** Every time you make a change to the codebase, you MUST document it in `docs/frontend/architecture.md` under the "Frontend Change History" section at the end of the file.
